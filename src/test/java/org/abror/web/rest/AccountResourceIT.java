...
class AccountResourceIT {
    ...
    void testRegisterValid() throws Exception {
        ...
        validUser.setHeight(175F);
        validUser.setWeight(17F);
        validUser.setAge(20);
    ...
    void testRegisterInvalidLogin() throws Exception {
        ...
        invalidUser.setHeight(175F);
        invalidUser.setWeight(17F);
    ...
    void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setHeight(175F);
        firstUser.setWeight(17F);
        firstUser.setAge(20);
        ...
        secondUser.setHeight(175F);
        secondUser.setWeight(17F);
    ...
    void testRegisterDuplicateEmail() throws Exception {
        ...
        userWithUpperCaseEmail.setHeight(175F);
        userWithUpperCaseEmail.setWeight(17F);
        userWithUpperCaseEmail.setAge(20);
    ...
    void testSaveAccount() throws Exception {
        ...
        userDTO.setHeight(175F);
        userDTO.setWeight(17F);
        userDTO.setAge(20);
