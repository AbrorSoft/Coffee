...
class UserResourceIT {
    ...
    private static final Float DEFAULT_HEIGHT = 175F;
    private static final Float UPDATED_HEIGHT = 176F;

    private static final Float DEFAULT_WEIGHT = 75F;
    private static final Float UPDATED_WEIGHT = 76F;
    ...
    void updateUser() throws Exception {
        ...
        user.setAge(UPDATED_AGE);
        user.setHeight(UPDATED_HEIGHT);
        user.setWeight(UPDATED_WEIGHT);
    ...
    void updateUserExistingEmail() throws Exception {
        ...
        anotherUser.setAge(20);
        anotherUser.setHeight(175F);
        anotherUser.setWeight(75F);
    ...
    void testUserDTOtoUser() {
        ...
        userDTO.setAge(DEFAULT_AGE);
        userDTO.setHeight(DEFAULT_HEIGHT);
        userDTO.setWeight(DEFAULT_WEIGHT);
