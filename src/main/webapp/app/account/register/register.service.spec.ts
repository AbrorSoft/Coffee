...
describe('RegisterService Service', () => {
  ...
  describe('Service methods', () => {
    it('should call register endpoint with correct values', () => {
      ...
      const height = 170;
      const weight = 75;
      const registration = new Registration(login, email, password, langKey, age, height, weight);
      ...
      // THEN
      expect(testRequest.request.body).toEqual({ email, langKey, login, password, age, height, weight });
    });
  });
});
